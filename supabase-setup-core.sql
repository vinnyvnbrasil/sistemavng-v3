-- Sistema VNG v3 - Configuracao do Banco de Dados (CORE)
...
-- Política simplificada para profiles - sem referência circular
...
-- Finalização
SELECT 'Configuração CORE do banco de dados concluída com sucesso!' as message;